...
<div class="report">
	...
	def report(self, df, title, subtitle, model_stats):
		...
		# Title
		console.print("=" * 128, style="white")
		console.print(" " * 60 + "Report:", style="magenta")
		console.print("=" * 128, style="white")
		# DataFrame
		console.print("-" * 128, style="white")
		console.print(df, style="white")
		console.print("-" * 128, style="white")
		# Stats
		console.print("Training stats:", style="white")
		report_model_names = list(config.data_config)
		console.print(f"{'Metric':<18} | " + " | ".join(f"{h:>10}" for h in report_model_names), style="white")
		console.print("-" * 128, style="white")
		for key, values in model_stats.items():
			console.print(f"{key:<18} | " + " | ".join(f"{float(v):>10.2f}" for v in values), style="white")
		console.print("-" * 128, style="white")
		# Meta
		console.print("Experimental setup:", style="white")
		console.print(json.dumps(self.machine_info, indent = 4), style="white")
		console.print("=" * 128, style="white")
